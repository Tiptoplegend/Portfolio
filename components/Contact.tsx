...
const socialLinks = [
  { name: "Github", href: "https://github.com/Tiptoplegend", icon: FiGithub },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/jeremiah-opoku-boateng-50384a296/",
    icon: FiLinkedin,
  },
  {
    name: "Twitter",
    href: "https://x.com/jerry_oboat?s=21&t=HmWWA81OIYCBhlLyw0d2Fg",
    icon: FiTwitter,
  },
];
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 min-h-[80vh] flex flex-col justify-center items-center text-center pt-24 pb-16">
        ...
        <motion.div style={{ x: springX, y: springY }}>
          <a
            href="mailto:oboatdev@gmail.com"
          ...
          >
            ...
            >
              <span className="font-mono text-sm md:text-lg tracking-wider">
                oboatdev@gmail.com
              </span>
